...
│  │ Workflows • Partner voice profiles • Operational procedures     │   │
│  └─────────────────────────────────────────────────────────────────┘   │
│                              ↓                                          │
│  ┌─────────────────────────────────────────────────────────────────┐   │
...
### Layer 4: Operational Skills (`.claude/skills/`)
...
### Cross-Session Memory (`docs/intelligence/`)

| File | Purpose | Status |
|------|---------|--------|
| `internal/context-intelligence-ledger.md` | Session memory, performance tracking | Optional |
...
The system uses **file-based context** with no persistent cross-session memory:

- Each session re-reads files from scratch
- Intelligence ledger stores learnings
