...
| `transcripts/[DATE]-[slug].md` | Transcript extraction logs | Generated by `/transcript` |
| `transcripts/voice-notes.md` | Accumulated voice observations | Auto-appended by `/transcript` |
...
| `transcript/SKILL.md` | Call transcript extraction (`/transcript`) | Skill |
...
| `internal/competitive-intelligence-tracking.md` | Competitive analysis log | Auto-appended by `/cmo` and `/analyst` |
| `internal/performance-analysis-history.md` | Performance findings and metrics | Auto-appended by `/cmo`, `/analyst`, and `/report` |
| `internal/seasonal-patterns.md` | Seasonal insights and timing patterns | Auto-appended by `/cmo` and `/analyst` |
...
| **Competitive intelligence log** | `docs/intelligence/internal/competitive-intelligence-tracking.md` |
| **Performance analysis history** | `docs/intelligence/internal/performance-analysis-history.md` |
| **Seasonal patterns log** | `docs/intelligence/internal/seasonal-patterns.md` |
| **Transcript extractions** | `content/transcripts/` |
| **Voice observations** | `content/transcripts/voice-notes.md` |
...
│         ↓           │            │  (includes prior    │
│ Execute operations  │            │   write-backs)      │
│         ↓           │            │         ↓           │
│ Write-back results  │─────────→ │ Intelligence informs│
│  to intel files     │            │ decisions           │
│         ↓           │            │         ↓           │
│ SessionEnd hook     │─────────→ │ SessionStart hook   │
│  appends ledger     │            │  reports freshness  │
└─────────────────────┘            └─────────────────────┘

Write-back targets (appended silently by /cmo, /analyst, /report, /transcript):
  competitive-intelligence-tracking.md  ← competitive pathways
  performance-analysis-history.md       ← performance pathways + /report metrics
  seasonal-patterns.md                  ← seasonal/monthly pathways
```
