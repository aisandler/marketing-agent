# {{COMPANY_NAME}} Strategic Pathways Reference

## Marketing Director Experience Framework

When the user triggers planning with **"let's plan"**, present this strategic pathway menu to enable marketing director-level decision making.
...
**Outcome**: Complete launch content suite ready for deployment  
**Process**:
1. Query user for new service details
2. Research market positioning and competitive advantages
3. Develop launch messaging aligned with brand guidelines
4. Create content for awareness, consideration, and conversion stages
...
**Deliverable**: 12-18 content records with prevention focus
...
**Required Inputs**: Current website analytics, traffic data, budget constraints  
**Outcome**: Prioritized opportunity report with ROI projections  
**Process**:
1. Request user analytics data and budget parameters
2. Analyze performance gaps and content opportunities
3. Research competitor strategies and market positioning
4. Calculate ROI projections for recommended content investments

**Deliverable**: 3-5 high-value content opportunities with business case

---

### **Performance Review & Optimization** 🔍  
**Required Inputs**: Content performance data, engagement metrics, ranking positions  
**Outcome**: Performance audit with specific improvement actions  
**Process**:
1. Request current content performance data
2. Identify underperforming content and optimization opportunities
3. Analyze engagement patterns and ranking challenges
4. Develop content refresh and gap-filling strategy

**Deliverable**: Optimization plan + 5-8 new content records to fill gaps

---

### **Competitive Response Strategy** 🔄
**Mixed Requirements**: Web research + user positioning data  
**Outcome**: Strategic response to competitive threats/opportunities  
**Process**:
1. Conduct competitive content analysis via web research
2. Query user on current market positioning and concerns
3. Identify competitive gaps and response opportunities
4. Develop counter-strategy content recommendations

**Deliverable**: Competitive analysis report + 6-10 response content records
...
1. **Agent Coordination**: Relevant agents perform research and analysis
2. **Strategic Consultation**: Present insights with targeted strategic questions
3. **User Decision**: User approves strategic direction
4. **Content Recommendations**: Generate specific content records
5. **LOCAL/SYSTEMATIC Classification**: Apply generation logic
6. **Chat Approval**: User approves content in conversation
7. **Pre-Generation**: LOCAL content generated, records sent to dashboard

---

## **Input Requirements Legend**

- *(Ready to Execute)* ✅ - Uses brand guidelines, web research, and agent analysis
- *(Requires Your Input)* 🔍 - Needs specific user data to execute properly  
- *(Mixed Requirements)* 🔄 - Combines web research with user-provided context